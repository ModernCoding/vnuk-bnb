...
public class BookingsController {
	...
	public String index(
			...
			@RequestParam(value = "roomId", required = false) String roomId, Model model, ServletRequest request
	...
	public String add(
			...
			@RequestParam(value = "roomTypesId", required = false) String roomTypesId, Model model,
	...
	public String edit(
			...
			@RequestParam(value = "countryId", required = false) String countryId,
			@RequestParam(value = "userTypesId", required = false) String userTypesId,
			@RequestParam(value = "roomTypesId", required = false) String roomTypesId, ServletRequest request,
	...
	public String create(
			...
			@Valid Booking booking, BindingResult bindingResult, ServletRequest request,
