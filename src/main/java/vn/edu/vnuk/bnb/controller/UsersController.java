...
public class UsersController {
	...
	public String index(
			...
			@RequestParam(value = "countryId", required = false) String countryId, Model model, ServletRequest request
	...
	public String add(
			...
			User user, Model model, @ModelAttribute("fieldErrors") ArrayList<FieldError> fieldErrors
	...
	public String edit(
			...
			User user, Model model, ServletRequest request,
	...
	public String create(
			...
			@Valid User user, BindingResult bindingResult, ServletRequest request, RedirectAttributes redirectAttributes
