...
public class RoomEquipmentsController {
	...
	public String index(
			...
			@RequestParam(value = "equipmentId", required = false) String equipmentId, Model model,
	...
	public String add(
			...
			RoomEquipment roomEquipment, @RequestParam(value = "roomTypesId", required = false) String roomTypesId,
			Model model, ServletRequest request, @ModelAttribute("fieldErrors") ArrayList<FieldError> fieldErrors
	...
	public String edit(
			...
			Room room, Model model, @RequestParam(value = "roomTypesId", required = false) String roomTypesId,
			ServletRequest request, @ModelAttribute("fieldErrors") ArrayList<FieldError> fieldErrors
	...
	public String create(
			...
			@Valid RoomEquipment roomEquipment, BindingResult bindingResult, ServletRequest request,
