...
public class DishTypesController {
	...
	public String add(DishType dishType, Model model,
	...
	public String edit(
			...
			DishType dishType, Model model, ServletRequest request,
			@ModelAttribute("fieldErrors") ArrayList<FieldError> fieldErrors
	...
	public String create(
			...
			@Valid DishType dishType, BindingResult bindingResult, ServletRequest request,
