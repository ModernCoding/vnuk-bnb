...
public class BillsController {
	...
	public String index(
			...
			@RequestParam(value = "userId", required = false) String userId, Model model, ServletRequest request
	...
	public String add(
			...
			Bill bill, @RequestParam(value = "roomId", required = false) String roomId,
			...
			@RequestParam(value = "countryId", required = false) String countryId, ServletRequest request,

			Model model, @ModelAttribute("fieldErrors") ArrayList<FieldError> fieldErrors
	...
	public String edit(
			...
			Bill bill, Model model, @RequestParam(value = "roomId", required = false) String roomId,
			@RequestParam(value = "userId", required = false) String userId,
			@RequestParam(value = "userTypesId", required = false) String userTypesId,
			@RequestParam(value = "identificationTypesId", required = false) String identificationTypesId,
			@RequestParam(value = "countryId", required = false) String countryId, ServletRequest request,
	...
	public String create(
			...
			@Valid Bill bill, BindingResult bindingResult, ServletRequest request, RedirectAttributes redirectAttributes
