...
public class UserController {
	...
	@Autowired
	public void setRoomTypesDao(UserTypeDao userTypeDao) {
    ...
    public String index(
	 ...
	 @RequestMapping("/users/{id}")
	    public String show(@PathVariable("id") Long id, Model model, ServletRequest request) throws SQLException{
	        model.addAttribute("user", userTypeDao.read(id));
	        model.addAttribute("user", identificationTypeDao.read(id));
	        model.addAttribute("user", countryDao.read(id));
