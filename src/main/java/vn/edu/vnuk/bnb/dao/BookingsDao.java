...
public class BookingsDao {
    ...
    //  READ (List of Tasks)
    public List<Bookings> read(String roomId,String userId) throws SQLException {
    	...
    	String sqlQuery = "select t01.id"
    			...
    			+ "     , t01.check_in "
    			+ "     , t01.check_out "
				+ "     , t01.quanlity_of_people "
				+ "  from bookings t01, users t02, rooms t03"
				//+ "join rooms_equipments t01 on t02.id = t01.room_id"
				+ " where t02.id = t01.user_id"
				+ " and t03.id = t01.room_id"
		;
